...
const Home = () => {
  ...
  const skills = [
    { icon: <CodeIcon fontSize="large" />, title: 'Frontend Development', description: 'React, TypeScript, Material-UI' },
    { icon: <BuildIcon fontSize="large" />, title: 'Backend Development', description: 'Node.js, Express, MongoDB' },
    { icon: <RocketLaunchIcon fontSize="large" />, title: 'Full Stack Solutions', description: 'End-to-end web applications' },
  ];
